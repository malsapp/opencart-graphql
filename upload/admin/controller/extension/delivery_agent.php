<?php
class ControllerExtensionDeliveryAgent extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('extension/delivery_agent');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_delivery_agent->addDeliveryAgent($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_delivery_agent->editDeliveryAgent($this->request->get['delivery_agent_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $delivery_agent_id) {
				$this->model_extension_delivery_agent->deleteDeliveryAgent($delivery_agent_id);
			}
	...
	protected function getList() {
		...
		$delivery_agent_total = $this->model_extension_delivery_agent->getTotalDeliveryAgent($filter_data);

		$results = $this->model_extension_delivery_agent->getDeliveryAgents($filter_data);

		foreach ($results as $result) {
			$data['delivery_agents'][] = array(
				'delivery_agent_id'    => $result['delivery_agent_id'],
				'name'           => $result['name'],
				'email'          => $result['email'],
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($delivery_agent_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($delivery_agent_total - $this->config->get('config_limit_admin'))) ? $delivery_agent_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $delivery_agent_total, ceil($delivery_agent_total / $this->config->get('config_limit_admin')));
...
protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['delivery_agent_id']) ? $this->language->get('text_add') : $this->language->get('text_edit');
		$data['text_enabled'] = $this->language->get('text_enabled');
		$data['text_disabled'] = $this->language->get('text_disabled');
		$data['text_yes'] = $this->language->get('text_yes');
		$data['text_no'] = $this->language->get('text_no');
		...
		} elseif (!empty($delivery_agent_info)) {
			$data['firstname'] = $delivery_agent_info['firstname'];
		} else {
			$data['firstname'] = '';
		}
		...
		if (isset($this->request->post['lastname'])) {
			...
			$data['lastname'] = $delivery_agent_info['lastname'];
		} else {
			$data['lastname'] = '';
		}
		...
		if (isset($this->request->post['email'])) {
			...
			$data['email'] = $delivery_agent_info['email'];
		} else {
			$data['email'] = '';
		}
		...
		if (isset($this->request->post['telephone'])) {
			...
			$data['telephone'] = $delivery_agent_info['telephone'];
		} else {
			$data['telephone'] = '';
		}
		...
		if (isset($this->request->post['status'])) {
			...
			$data['status'] = $delivery_agent_info['status'];
		} else {
			$data['status'] = true;
		}
		...
		} elseif (isset($this->request->get['delivery_agent_id'])) {
			$data['addresses'] = $this->model_extension_delivery_agent->getAddresses($this->request->get['delivery_agent_id']);
		} else {
		...
		if (isset($this->request->post['address_id'])) {
			...
			$data['address_id'] = $delivery_agent_info['address_id'];
		} else {
			$data['address_id'] = '';
		}
	...
	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/delivery_agent')) {
		...
		$delivery_agent_info = $this->model_extension_delivery_agent->getDeliveryAgentByEmail($this->request->post['email']);

		if (!isset($this->request->get['delivery_agent_id'])) {
			if ($delivery_agent_info) {
				$this->error['warning'] = $this->language->get('error_exists');
			}
		} else {
			if ($delivery_agent_info && ($this->request->get['delivery_agent_id'] != $delivery_agent_info['delivery_agent_id'])) {
				$this->error['warning'] = $this->language->get('error_exists');
			}
		}
		...
		if ($this->request->post['password'] || (!isset($this->request->get['delivery_agent_id']))) {
	...
	public function assign(){
		...
		$delivery_agent_id=$this->request->get['delivery_agent_id'];
		if($delivery_agent_id!=0){
			$this->load->model('extension/delivery_agent');
			$this->model_extension_delivery_agent->assignOrder($delivery_agent_id,$order_id);			
		}
	}
	...
	public function unassign(){
		...
		$order_id=$this->request->get['order_id'];
		$this->load->model('extension/delivery_agent');
		$this->model_extension_delivery_agent->unassignOrder($order_id);
	}
}