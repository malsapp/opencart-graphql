...
class ControllerExtensionModuleLoyality extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/loyality', 'user_token=' . $this->session->data['user_token'] . '&type=module', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/loyality', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/module/loyality', 'user_token=' . $this->session->data['user_token'], true);
